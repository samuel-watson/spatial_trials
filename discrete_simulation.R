...
for(i in 1:1000){
  ...
  if(is(fit2,"mcml")){
    ...
    dfci$lower[i] = quantile(b1,0.025)
    dfci$upper[i] = quantile(b1,0.975)
    dfcid$lower_i[i] = quantile(b2,0.025)
    dfcid$upper_i[i] = quantile(b2,0.975)
    dfcid$lower_e[i] = quantile(b3,0.025)
    dfcid$upper_e[i] = quantile(b3,0.975)
